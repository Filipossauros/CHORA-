...
describe('catálogo de regras (secção 6, normativa)', () => {
  ...
  it('inclui todas as famílias RN esperadas', () => {
    const esperadas = [
      'RN-101', 'RN-102', 'RN-103', 'RN-104', 'RN-105', 'RN-106', 'RN-107', 'RN-108', 'RN-109', 'RN-110',
      'RN-201', 'RN-202', 'RN-203', 'RN-204', 'RN-205', 'RN-206', 'RN-207', 'RN-208',
      'RN-301', 'RN-302', 'RN-303', 'RN-304', 'RN-305', 'RN-306',
      ...
      'RN-601', 'RN-602', 'RN-602-A', 'RN-603', 'RN-604', 'RN-605', 'RN-606', 'RN-607',
