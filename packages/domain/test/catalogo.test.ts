...
describe('catálogo de regras (secção 6, normativa)', () => {
  ...
  it('inclui todas as famílias RN esperadas', () => {
    const esperadas = [
      'RN-101', 'RN-102', 'RN-103', 'RN-104', 'RN-105', 'RN-106', 'RN-107', 'RN-110', 'RN-111', 'RN-112', 'RN-113', 'RN-114', 'RN-115', 'RN-116',
      ...
      'RN-601', 'RN-602', 'RN-602-A', 'RN-603', 'RN-604', 'RN-607', 'RN-608', 'RN-609', 'RN-610', 'RN-611', 'RN-612', 'RN-613',
